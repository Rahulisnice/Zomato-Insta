...
const UserRegister = () => {
  ...
  const focusClasses = "focus:ring-green-500 focus:border-green-500";
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 sm:p-10 transition duration-300 border border-gray-200 dark:border-gray-700">
        ...
        <div className="flex justify-center mb-10 bg-gray-200/70 dark:bg-gray-700/70 rounded-full p-1 shadow-inner">
          <button
            className="flex-1 py-2 px-4 text-sm font-semibold rounded-full bg-green-600 text-white shadow-md transition duration-200 transform hover:scale-[1.01]"
            aria-current="page"
          >
        ...
        <div className="text-center mb-10">
          <UserPlus className="w-12 h-12 mx-auto text-green-600 dark:text-green-400" />
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full flex justify-center items-center py-3 px-4 mt-8 border border-transparent rounded-xl shadow-lg text-base font-semibold text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-900 transition duration-200 transform active:scale-95"
          >
